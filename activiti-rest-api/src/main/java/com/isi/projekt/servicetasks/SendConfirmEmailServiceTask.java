...
public class SendConfirmEmailServiceTask implements JavaDelegate {
    @Override
    public void execute(DelegateExecution execution) {
        RunnerDTO runnerDTO = RunnerDTO.from(execution.getVariable("runnerDTO", String.class));

        sendEmail(runnerDTO.getEmail(), runnerDTO.getEmail());
    ...
    private void sendEmail(String email, String name) {
        ...
        finalText.append("\tdziekujemy za opłacenie biegu, twój pakiet został własnie wysłany").append("\n");
        finalText.append("\nPozdrawiamy, XYZ");
        ...
        try {
            ...
            message.setSubject("Potwierdzenie wysłania zestawu startowego");
